...
const WowEvent = () => {
    ...
    return (
        <main className="bg-black h-auto pb-24">
            <Navbar />
            <div>
                <div className="bg-[url('/Event_list/Wow.svg')] w-[100%] h-[27rem] mt-12 flex pl-36 items-center">
                    <div className='flex items-center'>
                        <img src="/Event_list/Wow.jpg" alt="Event_Photo" className='h-[24rem] w-[20rem] rounded-lg' />
