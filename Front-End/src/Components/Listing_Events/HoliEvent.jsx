...
const HoliEvent = () => {
  ...
  return (
    <main className="bg-black h-auto pb-24">
      <Navbar />
      <div>
        <div className="bg-[url('/Event_list/Holi.svg')] w-[100%] h-[27rem] mt-12 flex pl-36 items-center">
          <div className='flex items-center'>
            <img src="/Event_list/Holi_cover.jpg" alt="Event_Photo" className='h-[24rem] w-[20rem] rounded-lg' />
            <div className='flex flex-col items-center h-[23rem] justify-evenly'>
              <p className='text-white text-[4rem] font-display5'>Color-Thrill</p>
        ...
        <div className='pl-36 pr-96 mt-20 leading-[6rem]'>
          ...
          <p className='text-[#b3abab] text-base'>Dive into a world of vibrant colors and boundless excitement at Color-Thrill, our exhilarating Holi extravaganza! Get ready to immerse yourself in a whirlwind of joy with live music, dance performances, mouthwatering delicacies, and, of course, a riot of colors. Come, join us as we create unforgettable memories and celebrate the spirit of Holi in style!</p>
        </div>
        ...
        <div className='pl-36 mt-14 leading-[6rem]'>
          ...
          <div className='flex justify-between pr-[35rem]'>
                      <NavLink to='/dance'>
                          <div
                              class="relative overflow-hidden w-60 h-80 rounded-3xl cursor-pointer text-2xl font-bold bg-[url('/Event_list/MagicDance.jpg')] bg-no-repeat bg-cover"
                          >
