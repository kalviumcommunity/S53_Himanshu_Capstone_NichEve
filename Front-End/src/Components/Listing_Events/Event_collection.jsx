...
const Event_collection = () => {
    ...
    useEffect(() => {
        axios.get(URL)
            .then(res => {
                setIsPosts(res.data.Events.eventDetails)
                console.log(res.data.Events.eventDetails);
            }).catch(err => {
                console.log(err);
            })
    }, [id])
        ...
        <main className="bg-black h-auto pb-24">
            <Navbar />
            {
                Posts.map((data, index) => (
                    <div>
                        <div className="w-[100%] h-[27rem] mt-12 flex pl-36 items-center" style={{ backgroundImage: `url(${data.BgImg})` }}>
                            <div className='flex items-center'>
                                <img src={data.CoverImg} alt="Event_Photo" className='h-[24rem] w-[20rem] rounded-lg object-cover' />
                                <div className='flex flex-col items-center h-[23rem] justify-evenly'>
                                    <p className='text-white text-[4rem] font-display5'>{data.Name}</p>
                                    <div className='flex w-[6.8rem] justify-between items-center self-start pl-10'>
                                        ...
                                        <p className='text-white text-[1.5rem]'>{data.Like}</p>
                                    </div>
                        ...
                        <div className='pl-36 pr-96 mt-20 leading-[6rem]'>
                            ...
                            <p className='text-[#b3abab] text-base'><span className='text-3xl text-[#cfb93b]'>{data.Description.split(' ')[0]}</span> {data.Description.slice(data.Description.indexOf(' ') + 1)}</p>
                            {/* <p className='text-[#b3abab] text-base'>{data.Description.replace((' ')[0],'').trim()}</p> */}
                        </div>
                        <div className='text-white mt-16 pl-36 leading-[7rem]'>
                            ...
                            <div className='flex w-[25rem] justify-between text-[#b3abab]'>
                                <div className="items-center flex flex-col">
                                    <img src={data.GuestImg} alt="Guest1" className='w-24 h-24 rounded-full cursor-pointer' />
                                    <p className="font-bold">{data.Guest}</p>
                                </div>
                                {/* <div>
                        ...
                        <div className='pl-36 mt-14 leading-[6rem]'>
                            ...
                            <div className='flex justify-between pr-[35rem]'>
                                ...
                                <NavLink to={`/Events/6638c8b92113951a9b21b738`}>
                                    <div
...
export default Event_collection