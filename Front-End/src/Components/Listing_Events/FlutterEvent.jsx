...
const FlutterEvent = () => {
    ...
    return (
        <main className="bg-black h-auto pb-24">
            <Navbar />
            <div>
                <div className="bg-[url('/Event_list/FlutterBg.svg')] w-[100%] h-[27rem] mt-12 flex pl-36 items-center">
                    <div className='flex items-center'>
                        <img src="/Event_list/Flutter.png" alt="Event_Photo" className='h-[24rem] w-[20rem] rounded-lg' />
                        <div className='flex flex-col items-center h-[23rem] justify-evenly'>
                            <p className='text-white text-[4rem] font-display5 w-96'>Wonder of Wonders</p>
